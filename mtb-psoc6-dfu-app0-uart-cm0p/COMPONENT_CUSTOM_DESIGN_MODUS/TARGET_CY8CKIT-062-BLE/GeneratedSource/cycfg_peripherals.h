...
#define DFU_UART_ENABLED 1U
#define DFU_UART_HW SCB5
#define DFU_UART_IRQ scb_5_interrupt_IRQn

#if defined (CY_USING_HAL)
	extern const cyhal_resource_inst_t CYBSP_BLE_obj;
#endif //defined (CY_USING_HAL)
extern cy_stc_csd_context_t cy_csd_0_context;
extern const cy_stc_scb_uart_config_t DFU_UART_config;
#if defined (CY_USING_HAL)
	extern const cyhal_resource_inst_t DFU_UART_obj;
#endif //defined (CY_USING_HAL)
